  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        ...
        <Button onClick={() => setLocation("/quiz")} className="bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {primaryCards.map((card) => (
          <Link key={card.title} href={card.href}>
            <Card className="p-6 border-slate-200 bg-white hover:border-blue-400 hover:shadow-lg transition-all cursor-pointer flex flex-col justify-between h-full group">
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-blue-600">
                <span>{card.cta}</span>
